...
public class AuthController {
    ...
    @PostMapping("/login")
    public ResponseEntity<TokenResponseDTO> login(@Valid @RequestBody TokenRequestDTO tokenRequestDTO){
    ...
    public ResponseEntity<IntrospectResponseDTO> introspect(@RequestBody IntrospectRequestDTO requestDTO){
